...
class Parser:
    ...
    def __parse_game_slots(self) -> None:
        ...
        while (self.__next_line() is not None):
            ...
            slot = Layout.GAME_SLOT_ID_TO_OBJ[slot_id]
    ...
    def __parse_practice_slots(self) -> None:
        ...
        while (self.__next_line() is not None):
            ...
            slot = Layout.PRACTICE_SLOT_ID_TO_OBJ[slot_id]
    ...
    def __parse_games(self) -> None:
        ...
        while (self.__next_line() is not None):
            ...
            if ((game.age == "U12" or game.age == "U13") and game.tier == "T1"):
                ...
                Layout.Adders.add_game(special_game)
                Layout.UNWANTED[special_game.id] = set()
    ...
    def __parse_unwanted(self) -> None:
        ...
        while (self.__next_line() is not None):
            ...
            if activity_id in Layout.GAME_IDS:
                activity_type = ActivityType.GAME
            elif activity_id in Layout.PRACTICE_IDS:
    ...
    def __parse_preferences(self) -> None:
        ...
        while (self.__next_line() is not None):
            ...
            if activity_id in Layout.ACTIVITY_IDS:
                Layout.Adders.add_preference(preference)
            else:
                ...
                print(
                    "NOTE: a preference listing has appeared for an activity that does not exist. This is not a bug and can be safely ignored.")
    ...
    def __parse_game_id(self, game_id: str) -> Game:
        ...
        if len(split_id) != 4: raise RuntimeError(
            "Issue parsing game '" + game_id + "': split does not result in four elements")
    ...
    def __parse_practice_id(self, practice_id: str) -> Practice:
        ...
        if not (len(split_id) == 4 or len(split_id) == 6): raise RuntimeError(
            "Issue parsing practice '" + practice_id + "': split does not result in four or six elements")
